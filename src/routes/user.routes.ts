...
import { createUserHandler, forgotPasswordHandler, getCurrentUser, resetPasswordHandler, verifyUserHandler } from '../controller/user.controller'
...
router.get('/api/users/me', requireUser, getCurrentUser)
